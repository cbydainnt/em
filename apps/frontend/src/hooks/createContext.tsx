...
import { modelInputProps, modelSticker } from "../helpers/Interface";
...
interface contextProps {
  ...
  imageSize: [
    ...
    setImageSize: (e: {w: number; h: number} | null) => void
  ];
  imageExt: [
    imageExt: string | null,
    setImageExt: (e: string | null) => void
  ];
  prevImage: [
  ...
  stickers: [
    stickers: modelSticker[],
    setStickers: (e: modelSticker[]) => void
  ];
  activeSticker: [
  ...
  isChange: [
    ...
    setIsChange: React.Dispatch<React.SetStateAction<boolean | null>>
  ];
  showLoadingModal: [
