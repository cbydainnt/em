...
const API_ENDPOINT =  import.meta.env.VITE_API_ENDPOINT ? import.meta.env.VITE_API_ENDPOINT :'https://model-zoo.metademolab.com/predictions/segment_everything_box_model';
const ALL_MASK_API_ENDPOINT = import.meta.env.VITE_ALL_MASK_API_ENDPOINT ? import.meta.env.VITE_ALL_MASK_API_ENDPOINT : 'https://model-zoo.metademolab.com/predictions/automatic_masks';
const ERASE_API_ENDPOINT = import.meta.env.VITE_ERASE_API_ENDPOINT ? import.meta.env.VITE_ERASE_API_ENDPOINT : 'https://model-zoo.metademolab.com/predictions/automatic_masks';
