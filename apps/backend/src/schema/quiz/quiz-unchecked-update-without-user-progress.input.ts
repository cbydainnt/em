...
import { QuizUncheckedUpdateManyWithoutParent_quizNestedInput } from './quiz-unchecked-update-many-without-parent-quiz-nested.input';
...
@InputType()
export class QuizUncheckedUpdateWithoutUser_progressInput {
    ...
    @Field(() => QuizUncheckedUpdateManyWithoutParent_quizNestedInput, {nullable:true})
    quiz_versions?: QuizUncheckedUpdateManyWithoutParent_quizNestedInput;
