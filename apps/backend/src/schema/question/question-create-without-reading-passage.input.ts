...
import { QuizAudioCreateNestedOneWithoutQuestionsInput } from '../quiz-audio/quiz-audio-create-nested-one-without-questions.input';
...
@InputType()
export class QuestionCreateWithoutReading_passageInput {
    ...
    @Field(() => QuizAudioCreateNestedOneWithoutQuestionsInput, {nullable:true})
    audio?: QuizAudioCreateNestedOneWithoutQuestionsInput;
