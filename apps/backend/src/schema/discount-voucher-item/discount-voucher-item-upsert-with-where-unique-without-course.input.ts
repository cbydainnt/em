...
@InputType()
export class DiscountVoucherItemUpsertWithWhereUniqueWithoutCourseInput {
    ...
    update!: DiscountVoucherItemUpdateWithoutCourseInput;

    @Field(() => DiscountVoucherItemCreateWithoutCourseInput, {nullable:false})
    @Type(() => DiscountVoucherItemCreateWithoutCourseInput)
    create!: DiscountVoucherItemCreateWithoutCourseInput;
}
