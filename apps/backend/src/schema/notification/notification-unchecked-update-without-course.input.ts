...
import { UserNotificationUncheckedUpdateManyWithoutNotificationNestedInput } from '../user-notification/user-notification-unchecked-update-many-without-notification-nested.input';

@InputType()
export class NotificationUncheckedUpdateWithoutCourseInput {
    ...
    @Field(() => UserNotificationUncheckedUpdateManyWithoutNotificationNestedInput, {nullable:true})
