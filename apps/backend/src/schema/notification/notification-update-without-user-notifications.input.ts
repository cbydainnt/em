...
import { CourseUpdateOneWithoutNotificationsNestedInput } from '../course/course-update-one-without-notifications-nested.input';
import { LessonUpdateOneWithoutNotificationsNestedInput } from '../lesson/lesson-update-one-without-notifications-nested.input';

@InputType()
export class NotificationUpdateWithoutUserNotificationsInput {
    ...
    @Field(() => CourseUpdateOneWithoutNotificationsNestedInput, {nullable:true})
    course?: CourseUpdateOneWithoutNotificationsNestedInput;
