...
import { AnswerAvgAggregateInput } from './answer-avg-aggregate.input';
import { AnswerSumAggregateInput } from './answer-sum-aggregate.input';
...
export class AnswerGroupByArgs {
    ...
    @Field(() => AnswerAvgAggregateInput, {nullable:true})
    _avg?: AnswerAvgAggregateInput;

    @Field(() => AnswerSumAggregateInput, {nullable:true})
    _sum?: AnswerSumAggregateInput;
