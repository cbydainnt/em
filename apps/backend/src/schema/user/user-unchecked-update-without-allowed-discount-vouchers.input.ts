...
import { CourseViewUncheckedUpdateManyWithoutUserNestedInput } from '../course-view/course-view-unchecked-update-many-without-user-nested.input';

@InputType()
export class UserUncheckedUpdateWithoutAllowed_discount_vouchersInput {
    ...
    @Field(() => CourseViewUncheckedUpdateManyWithoutUserNestedInput, {nullable:true})
    course_view?: CourseViewUncheckedUpdateManyWithoutUserNestedInput;
}
