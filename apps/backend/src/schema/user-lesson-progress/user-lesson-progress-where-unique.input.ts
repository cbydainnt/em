...
import { UserLessonProgressUser_idLesson_idCompoundUniqueInput } from './user-lesson-progress-user-id-lesson-id-compound-unique.input';
...
@InputType()
export class UserLessonProgressWhereUniqueInput {

    @Field(() => String, {nullable:true})
    id?: string;

    @Field(() => UserLessonProgressUser_idLesson_idCompoundUniqueInput, {nullable:true})
