...
import { UserQuizProgressUser_idQuiz_idLesson_idAttemptsCompoundUniqueInput } from './user-quiz-progress-user-id-quiz-id-lesson-id-attempts-compound-unique.input';
...
@InputType()
export class UserQuizProgressWhereUniqueInput {

    @Field(() => String, {nullable:true})
    progress_id?: string;

    @Field(() => UserQuizProgressUser_idQuiz_idLesson_idAttemptsCompoundUniqueInput, {nullable:true})
    user_id_quiz_id_lesson_id_attempts?: UserQuizProgressUser_idQuiz_idLesson_idAttemptsCompoundUniqueInput;
