...
@InputType()
export class UserQuizProgressUpsertWithWhereUniqueWithoutCourseInput {
    ...
    update!: UserQuizProgressUpdateWithoutCourseInput;

    @Field(() => UserQuizProgressCreateWithoutCourseInput, {nullable:false})
    @Type(() => UserQuizProgressCreateWithoutCourseInput)
    create!: UserQuizProgressCreateWithoutCourseInput;
}
