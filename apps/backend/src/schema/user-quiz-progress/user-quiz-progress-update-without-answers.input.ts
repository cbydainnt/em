...
import { CourseUpdateOneWithoutUser_quiz_progressNestedInput } from '../course/course-update-one-without-user-quiz-progress-nested.input';

@InputType()
export class UserQuizProgressUpdateWithoutAnswersInput {
    ...
    @Field(() => CourseUpdateOneWithoutUser_quiz_progressNestedInput, {nullable:true})
    course?: CourseUpdateOneWithoutUser_quiz_progressNestedInput;
}
