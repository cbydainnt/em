...
import { UserQuizAnswerUncheckedUpdateManyWithoutProgressNestedInput } from '../user-quiz-answer/user-quiz-answer-unchecked-update-many-without-progress-nested.input';

@InputType()
export class UserQuizProgressUncheckedUpdateWithoutLessonInput {
    ...
    @Field(() => UserQuizAnswerUncheckedUpdateManyWithoutProgressNestedInput, {nullable:true})
    answers?: UserQuizAnswerUncheckedUpdateManyWithoutProgressNestedInput;
}
