...
@InputType()
export class UserQuizProgressScalarWhereInput {

    @Field(() => [UserQuizProgressScalarWhereInput], {nullable:true})
    AND?: Array<UserQuizProgressScalarWhereInput>;

    @Field(() => [UserQuizProgressScalarWhereInput], {nullable:true})
    OR?: Array<UserQuizProgressScalarWhereInput>;

    @Field(() => [UserQuizProgressScalarWhereInput], {nullable:true})
    NOT?: Array<UserQuizProgressScalarWhereInput>;
