...
import { LessonCreateNestedOneWithoutReportsInput } from '../lesson/lesson-create-nested-one-without-reports.input';
...
@InputType()
export class ReportCreateWithoutResolverInput {
    ...
    @Field(() => LessonCreateNestedOneWithoutReportsInput, {nullable:true})
    lesson?: LessonCreateNestedOneWithoutReportsInput;
