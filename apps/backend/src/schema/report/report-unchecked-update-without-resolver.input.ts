...
import { ReportCommentUncheckedUpdateManyWithoutReportNestedInput } from '../report-comment/report-comment-unchecked-update-many-without-report-nested.input';

@InputType()
export class ReportUncheckedUpdateWithoutResolverInput {
    ...
    @Field(() => ReportCommentUncheckedUpdateManyWithoutReportNestedInput, {nullable:true})
    comments?: ReportCommentUncheckedUpdateManyWithoutReportNestedInput;
}
