...
import { OrderItemUncheckedUpdateManyWithoutCourseNestedInput } from '../order-item/order-item-unchecked-update-many-without-course-nested.input';
...
@InputType()
export class CourseUncheckedUpdateWithoutUser_lesson_progressInput {
    ...
    @Field(() => OrderItemUncheckedUpdateManyWithoutCourseNestedInput, {nullable:true})
    order_items?: OrderItemUncheckedUpdateManyWithoutCourseNestedInput;
