...
import { DiscountVoucherItemUncheckedCreateNestedManyWithoutCourseInput } from '../discount-voucher-item/discount-voucher-item-unchecked-create-nested-many-without-course.input';
import { QuizUncheckedCreateNestedManyWithoutCourseInput } from '../quiz/quiz-unchecked-create-nested-many-without-course.input';

@InputType()
export class CourseUncheckedCreateWithoutUser_lesson_progressInput {
    ...
    @Field(() => DiscountVoucherItemUncheckedCreateNestedManyWithoutCourseInput, {nullable:true})
    discount_vouchers?: DiscountVoucherItemUncheckedCreateNestedManyWithoutCourseInput;
