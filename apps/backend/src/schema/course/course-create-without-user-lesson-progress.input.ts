...
import { UserQuizProgressCreateNestedManyWithoutCourseInput } from '../user-quiz-progress/user-quiz-progress-create-nested-many-without-course.input';
...
@InputType()
export class CourseCreateWithoutUser_lesson_progressInput {
    ...
    @Field(() => UserQuizProgressCreateNestedManyWithoutCourseInput, {nullable:true})
    user_quiz_progress?: UserQuizProgressCreateNestedManyWithoutCourseInput;
