...
import { SectionUpdateManyWithoutCourseNestedInput } from '../section/section-update-many-without-course-nested.input';
...
@InputType()
export class CourseUpdateWithoutUser_lesson_progressInput {
    ...
    @Field(() => SectionUpdateManyWithoutCourseNestedInput, {nullable:true})
