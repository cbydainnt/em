...
import { CourseUpdateOneRequiredWithoutUser_coursesNestedInput } from '../course/course-update-one-required-without-user-courses-nested.input';

@InputType()
export class UserCourseUpdateWithoutUserInput {
    ...
    @Field(() => CourseUpdateOneRequiredWithoutUser_coursesNestedInput, {nullable:true})
