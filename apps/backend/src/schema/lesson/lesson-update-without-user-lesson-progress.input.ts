...
import { SectionUpdateOneRequiredWithoutLessonsNestedInput } from '../section/section-update-one-required-without-lessons-nested.input';
...
@InputType()
export class LessonUpdateWithoutUser_lesson_progressInput {
    ...
    @Field(() => SectionUpdateOneRequiredWithoutLessonsNestedInput, {nullable:true})
