...
import { UserQuizProgressCreateNestedManyWithoutLessonInput } from '../user-quiz-progress/user-quiz-progress-create-nested-many-without-lesson.input';
...
@InputType()
export class LessonCreateWithoutUser_lesson_progressInput {
    ...
    @Field(() => UserQuizProgressCreateNestedManyWithoutLessonInput, {nullable:true})
    user_quiz_progress?: UserQuizProgressCreateNestedManyWithoutLessonInput;
