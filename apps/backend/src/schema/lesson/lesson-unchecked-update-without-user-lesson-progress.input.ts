...
import { UserQuizProgressUncheckedUpdateManyWithoutLessonNestedInput } from '../user-quiz-progress/user-quiz-progress-unchecked-update-many-without-lesson-nested.input';
...
@InputType()
export class LessonUncheckedUpdateWithoutUser_lesson_progressInput {
    ...
    @Field(() => UserQuizProgressUncheckedUpdateManyWithoutLessonNestedInput, {nullable:true})
    user_quiz_progress?: UserQuizProgressUncheckedUpdateManyWithoutLessonNestedInput;
