...
import { UserQuizProgressUncheckedCreateNestedManyWithoutLessonInput } from '../user-quiz-progress/user-quiz-progress-unchecked-create-nested-many-without-lesson.input';
...
import { LessonQuizUncheckedCreateNestedManyWithoutLessonInput } from '../lesson-quiz/lesson-quiz-unchecked-create-nested-many-without-lesson.input';

@InputType()
export class LessonUncheckedCreateWithoutUser_lesson_progressInput {
    ...
    @Field(() => UserQuizProgressUncheckedCreateNestedManyWithoutLessonInput, {nullable:true})
    user_quiz_progress?: UserQuizProgressUncheckedCreateNestedManyWithoutLessonInput;
    ...
    @Field(() => LessonQuizUncheckedCreateNestedManyWithoutLessonInput, {nullable:true})
    lesson_quizzes?: LessonQuizUncheckedCreateNestedManyWithoutLessonInput;
}
