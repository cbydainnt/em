...
import { ComboCourseUncheckedCreateNestedManyWithoutComboInput } from '../combo-course/combo-course-unchecked-create-nested-many-without-combo.input';
...
@InputType()
export class ComboUncheckedCreateWithoutDiscount_vouchersInput {
    ...
    @Field(() => ComboCourseUncheckedCreateNestedManyWithoutComboInput, {nullable:true})
    courses?: ComboCourseUncheckedCreateNestedManyWithoutComboInput;
