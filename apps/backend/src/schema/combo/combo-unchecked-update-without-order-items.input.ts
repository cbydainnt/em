...
import { DiscountVoucherItemUncheckedUpdateManyWithoutComboNestedInput } from '../discount-voucher-item/discount-voucher-item-unchecked-update-many-without-combo-nested.input';

@InputType()
export class ComboUncheckedUpdateWithoutOrder_itemsInput {
    ...
    @Field(() => DiscountVoucherItemUncheckedUpdateManyWithoutComboNestedInput, {nullable:true})
    discount_vouchers?: DiscountVoucherItemUncheckedUpdateManyWithoutComboNestedInput;
}
