...
import { QuestionUncheckedUpdateManyWithoutReading_passageNestedInput } from '../question/question-unchecked-update-many-without-reading-passage-nested.input';

@InputType()
export class ReadingPassageUncheckedUpdateInput {
    ...
    @Field(() => QuestionUncheckedUpdateManyWithoutReading_passageNestedInput, {nullable:true})
    questions?: QuestionUncheckedUpdateManyWithoutReading_passageNestedInput;
}
