...
import { DiscountVoucherUsageUpdateManyWithoutVoucherNestedInput } from '../discount-voucher-usage/discount-voucher-usage-update-many-without-voucher-nested.input';
...
@InputType()
export class DiscountVoucherUpdateWithoutApplicable_itemsInput {
    ...
    @Field(() => DiscountVoucherUsageUpdateManyWithoutVoucherNestedInput, {nullable:true})
    used_by?: DiscountVoucherUsageUpdateManyWithoutVoucherNestedInput;
