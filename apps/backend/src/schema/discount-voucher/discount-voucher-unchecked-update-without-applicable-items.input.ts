...
import { OrderUncheckedUpdateManyWithoutDiscount_voucherNestedInput } from '../order/order-unchecked-update-many-without-discount-voucher-nested.input';

@InputType()
export class DiscountVoucherUncheckedUpdateWithoutApplicable_itemsInput {
    ...
    @Field(() => OrderUncheckedUpdateManyWithoutDiscount_voucherNestedInput, {nullable:true})
    order?: OrderUncheckedUpdateManyWithoutDiscount_voucherNestedInput;
}
