...
import { DiscountVoucherUsageUncheckedCreateNestedManyWithoutVoucherInput } from '../discount-voucher-usage/discount-voucher-usage-unchecked-create-nested-many-without-voucher.input';
...
@InputType()
export class DiscountVoucherUncheckedCreateWithoutApplicable_usersInput {
    ...
    @Field(() => DiscountVoucherUsageUncheckedCreateNestedManyWithoutVoucherInput, {nullable:true})
    used_by?: DiscountVoucherUsageUncheckedCreateNestedManyWithoutVoucherInput;
